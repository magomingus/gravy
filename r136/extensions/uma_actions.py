...
def execute_python_code(
    ...
    docker_image = "joshxt/safeexecute:main"
    docker_working_dir = f"/r136/WORKSPACE/{agent_id}/{conversation_id}"
    os.makedirs(docker_working_dir, exist_ok=True)
    host_working_dir = os.getenv("WORKING_DIRECTORY", "/r136/WORKSPACE")
...
class r136_actions(Extensions):
    """
    The r136 Actions extension contains commands that allow the r136 Agents to work with other agents and use pre-built chains to complete tasks.
    """
    ...
    def __init__(self, **kwargs):
        self.commands = {
            ...
            "Get CSV Prr136w": self.get_csv_prr136w,
            "Get CSV Prr136w Text": self.get_csv_prr136w_text,
    ...
    async def replace_init_in_file(self, filename: str, new_init: str):
        ...
        return f"{r136_uri}/outputs/extensions/{filename}"
    ...
    async def generate_openapi_chain(
        ...
        """
        Generate an r136 extension from an OpenAPI JSON URL
...
"""
    ...
    async def get_csv_prr136w(self, filename: str):
        """
        Get a prr136w of a CSV file

        Args:
        filename (str): The filename

        Returns:
        str: The prr136w of the CSV file consisting of the first 2-5 lines
        """
    ...
    async def get_csv_prr136w_text(self, text: str):
        """
        Get a prr136w of a CSV text

        Args:
        text (str): The text

        Returns:
        str: The prr136w of the CSV text consisting of the first 2-5 lines
        """
        lines = text.split("\n")
        if len(lines) > 5:
            lines = lines[:5]
    ...
    async def convert_string_to_pydantic_model(
        ...
        response = self.ApiClient.prompt_agent(
            ...
            prompt_args={
                ...
                "schema": schema,
                "conversation_name": "r136 Terminal",
            },
        )
