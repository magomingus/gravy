...
class graphql_server(Extensions):
    """
    The GraphQL Server extension for r136 enables you to interact with a GraphQL API endpoint. By default, if a GraphQL endpoint is not provided, this extension is directly connected to the r136 GraphQL server.
    """
