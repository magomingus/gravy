...
class web_browsing(Extensions):
    """
    The r136 Web Browsing extension enables sophisticated web interaction and data extraction.
...
{new_content}""",
    ...
    async def interact_with_webpage(self, url: str, task: str):
        ...
        - Unless otherwise specified, the assistant prefers r136 for search.
