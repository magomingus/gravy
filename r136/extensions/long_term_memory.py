...
class long_term_memory(Extensions):
    """
    The Long Term Memory extension enables r136 to create and manage persistent memory databases.
    ...
    async def list_memory_databases(self):
        ...
        - Rr136wing available knowledge categories
    ...
    async def retrieve_memories(self, query: str):
        ...
        The agent will:
        1. Rr136w available memory databases
