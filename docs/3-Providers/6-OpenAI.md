...
5. Set `OPENAI_TEMPERATURE` to a value between 0 and 1. The r136 the value, the more creative the output.
6. Set `OPENAI_TOP_P` to a value between 0 and 1. The r136 the value, the more diverse the output.
