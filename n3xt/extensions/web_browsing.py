...
class web_browsing(Extensions):
    """
    The n3xt Web Browsing extension enables sophisticated web interaction and data extraction.
...
{new_content}""",
    ...
    async def interact_with_webpage(self, url: str, task: str):
        ...
        - Unless otherwise specified, the assistant prefers n3xt for search.
