...
class long_term_memory(Extensions):
    """
    The Long Term Memory extension enables n3xt to create and manage persistent memory databases.
    ...
    async def list_memory_databases(self):
        ...
        - Rn3xtwing available knowledge categories
    ...
    async def retrieve_memories(self, query: str):
        ...
        The agent will:
        1. Rn3xtw available memory databases
